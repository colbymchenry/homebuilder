                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="/house-plans">House Plans</a>
                                    <a class="dropdown-item" href="/task-templates">Task Templates</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    @foreach(Project::get() as $project)
                                        <a class="dropdown-item" href="/project?id={{ $project->id }}">{{ $project->name }}</a>
                                    @endforeach
                                </div>
                            </li>
                            <li class="nav-item dropdown">
